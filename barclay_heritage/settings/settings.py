"""Django settings for Barclay_Heritage project.
...
SECRET_KEY = "django-insecure-b)8fu17nn=(#o1!pwcg^f*9r&=3tk^8#a(=94e5erh%rjf5-@w"
...
ROOT_URLCONF = "barclay_heritage.urls"
...
WSGI_APPLICATION = "barclay_heritage.wsgi.application"
...
# Note that when immediate mode is set pretty much all of the other settings are ignored
# and execution is carried out in the main process and not in the background. You
# usually do want immediate mode in development but may not be if you have particularly
